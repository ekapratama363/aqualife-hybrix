...
class Product_model extends CI_Model
{
    ...
    private function base_query($select, $data)
    {
        ...
        if (isset($data['slug'])) {
            ...
            $query->where("(products.category_id IN (SELECT id FROM categories WHERE slug = $slug) OR products.category_id IN (SELECT id FROM categories WHERE category_id IN (SELECT id FROM categories WHERE slug = $slug)))");
        }
