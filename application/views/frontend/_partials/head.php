        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center">
                    <form id="search-form" action="<?= base_url("frontend/News/search");?>" method="post">
                        <div class="relative">
                            <input type="text" placeholder="Search" id="search" name="search" class="bg-gray-100 border border-gray-300 rounded-full py-2 pl-4 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4">
                ...
                <form id="search-form" action="<?= base_url("frontend/News/search");?>" method="post">
                    <div class="mt-2 relative">
                        <input type="text" placeholder="Search" name="search" id ="search" class="w-full bg-gray-100 border border-gray-300 rounded-full py-2 pl-4 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <button class="absolute inset-y-0 right-0 flex items-center pr-3" type="submit">
                            <i data-feather="search" class="h-5 w-5 text-gray-400"></i>
                        </button>
                    </div>
