...
<main>
    ...
    <section class="container mx-auto px-6 py-20 text-center">
        ...
        <div class="mt-12 grid md:grid-cols-2 gap-x-12 gap-y-8 max-w-5xl mx-auto text-left">
            ...
            ?>
            <div>
                <h4 class="text-xl font-bold text-gray-900"><?= $dyk2->title;?></h4>
                <p class="mt-2 text-gray-600"><?= $dyk2->description;?></p>
            </div>
            <?php
                    }
                }
    ...
    <section class="py-20 bg-gray-50 pt-20">
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-4xl font-bold text-blue-600"><?= $advantage->title;?></h2>
                    <p class="mt-2 text-gray-600"><?= $advantage->description;?></p>
                </div>
                <div>
                    <img src="<?= base_url('uploads/');?>images/products/advantage/<?= $advantage->images;?>" alt="Perbandingan Sebelum & Sesudah Aqualife" class="rounded-2xl w-full shadow-xl">
                </div>
            </div>
        </div>
    </section>
