            ...
            <div class="app-menu navbar-menu">
                ...
                <div class="navbar-brand-box">
                    <a href="<?= base_url('backend/home/consultation') ?>" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?= base_url(); ?>assets/hybrix/images/logo-sm.png" alt="" height="26">
                        </span>
                        <span class="logo-lg">
                            <img src="<?= base_url(); ?>assets/hybrix/images/logo-dark.png" alt="" height="26">
                        </span>
                    </a>
                    <a href="<?= base_url('backend/home/consultation') ?>" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="<?= base_url(); ?>assets/hybrix/images/logo-sm.png" alt="" height="24">
                        </span>
                        <span class="logo-lg">
                            <img src="<?= base_url(); ?>assets/hybrix/images/logo-light.png" alt="" height="24">
                        </span>
                    </a>
